...
public class Test_jd01_06  extends HomeWork {
    ...
    public void testTaskB2() throws Exception {
        System.out.println("Проверочный фрагмент вывода:\n" +
        ...
        run("").include("" +
                        ...
                        //а также, есть разное понимание троеточия,
                        //одни слушатели считают что это конец предложения другие что недосказанность
                        //поэтому проверяем одинаковую при обоих подходах часть
                        "У лукоморья дуб зелёный Златая цепь на дубе том\n" +
                        "Идёт направо песнь заводит Налево сказку говорит\n" +
                        "Там на неведомых дорожках Следы невиданных зверей\n" +
                        "И днём и ночью кот учёный Всё ходит по цепи кругом\n" +
                        ...
                        "Избушка там на курьих ножках Стоит без окон без дверей\n" +
                        "В темнице там царевна тужит А бурый волк ей верно служит\n" +
                        //вот это спорное предложение: - Там царь Кащей над златом чахнет Там русский дух там Русью пахнет
    ...
    public void testTaskC2() throws Exception {
        ...
        long dtFast = (System.nanoTime() - t) / 100010;
